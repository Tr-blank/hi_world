<template>
  <ul>
    <li
      ...
      @click="updateCurrentChallenge(challenge)"
      class="border-t py-1 cursor-pointer flex justify-between"
    >
      <div>{{ challenge.title }}</div>
      <div v-show="challenge.id === currentChallengeId">></div>
    </li>
  </ul>
</template>
<script setup>
